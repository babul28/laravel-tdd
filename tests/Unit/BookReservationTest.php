...
class BookReservationTest extends TestCase
{
    ...
    /** @test */
    public function an_user_can_checked_out_a_book_twice()
    {
        $book = Book::factory()->create();
        $user = User::factory()->create();
    ...
    // an user can checkout a book twice
    /** @test */
    public function if_not_checked_out_exception_is_thrown()
    {
        // If you except an exception,
        // you must define that on the first of body function
